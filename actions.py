...
def results(loc,cuisine,price):
	...
	d = []
	df = pd.DataFrame()
	results = zomato.restaurant_search("", lat, lon, str(cuisines_dict.get(cuisine)), limit=50)
...
def Config():
	gmail_user = 'resto.bot2212@gmail.com'
	gmail_pwd = 'Resto-bot000'
